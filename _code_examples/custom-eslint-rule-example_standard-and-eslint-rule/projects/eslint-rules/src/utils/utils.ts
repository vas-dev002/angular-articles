...
export function getParameterPropertiesFromMethodDefinition(
  node: TSESTree.MethodDefinition,
): Array<TSESTree.TSParameterProperty> {
  ...
  return (value.params as Array<TSESTree.TSParameterProperty>).filter((node: TSESTree.TSParameterProperty) =>
    isParameterProperty(node),
  );
}

export function isParameterPropertyAccessibilityNamed(
